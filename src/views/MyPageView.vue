  ...
  <div>
    <div class="mypage-container">
      <div class="mypage-header">
        <div class="mypage-content"><img class ="my-picture"  :src="profileImageUrl" alt = photo></div>
        <section>
      ...
      <div class="tappage">
        <a href=""><span><i class="fas fa-th fa-1x" style="color:#A6A6A6">  게시물</i></span></a>
        <a href=""><span><i class="fas fa-map fa-1x" style="color:#A6A6A6">  지도</i></span></a>
